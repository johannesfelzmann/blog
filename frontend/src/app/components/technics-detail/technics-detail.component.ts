...
@Component({
  selector: 'app-technics-detail',
  templateUrl: './technics-detail.component.html',
  styleUrls: ['./technics-detail.component.scss']
})
export class TechnicsDetailComponent implements OnInit {
  postId = 0;
  postItem: Post;
  imgURL = [];
